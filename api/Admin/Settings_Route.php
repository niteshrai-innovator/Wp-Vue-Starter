...
class Settings_Route extends WP_REST_Controller  {
    ...
    public function get_items( $request ) {
        $response = [
            'firstname' => get_option( 'wkwp_erp_addon_settings_firstname', true ),
            'lastname'  => get_option( 'wkwp_erp_addon_settings_lastname', true ),
            'email'     => get_option( 'wkwp_erp_addon_settings_email', true ),
        ];
